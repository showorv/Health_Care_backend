...
import { DoctorScheduleController } from "./doctorScedule.controller";
...
router.get("/", checkAuth(Role.ADMIN, Role.SUPERADMIN), DoctorScheduleController.getAllDoctorSchedules);
router.get("/:doctorId/schedule/:scheduleId", checkAuth(Role.ADMIN, Role.SUPERADMIN), DoctorScheduleController.getDoctorScheduleById);
